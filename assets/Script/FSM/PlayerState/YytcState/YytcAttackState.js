...
var YytcAttackState = cc.Class({
    ...
    BreakCondition :function( ) {
        if (this.bAttackOver){
            ...
            this.FSMMgr.TransState(FSMUtil.TransConditionID.YytcAttToNor, null, this);
            this.bAttackOver = false;
            this.BeThrowDart = false;
            return;
        }
    ...
    OnAttAnimationThrow : function( InString ,InNumber , InBoolean ){
        ...
        if ( this.WeaponParam.id ){
            ...
            if (CurWeapon){
                ...
                var FlyWeaponJS = CurWeapon.getComponent("YytcSprite");
                //FlyWeaponJS.InitWeaponData(this.WeaponParam);

                //FlyWeaponJS.SetAttackType();
                FlyWeaponJS.ReduceWeaponCount(this.WeaponParam.id);
            }
            //PoolManager.
        }
    },
...
module.exports = YytcAttackState
